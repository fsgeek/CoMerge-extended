...
blind_stand	= [28.67, 168.15]
blind_coloc	= [47.17, 203.05]
...
heads = ('All Fast', 'Merge Standalone', 'Co-Merge Standalone', 'Merge Collocated', 'Co-Merge Collocated')
ax.legend((rects1, rects2, rects3, rects4, rects5), heads, loc='upper center', ncol=3, fontsize = 11, bbox_to_anchor=(0.5, 1.55))
